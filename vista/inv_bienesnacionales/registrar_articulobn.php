    ...
    <form class="formulario" action="../controlador/control_docente.php" method="POST" name="form_docente">
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Seleccione Tipo de Artículo <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Tipo de Artículo del Bien Nacional."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Seleccione Modelo <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Modelo del Bien Nacional."><i class="fa fa-question" ></i></span></label>
                <select name="nacionalidaddoc" id="cam_nacionalidaddoc">
                    <option value="" <?php if($Datos_Docente['nacionalidaddoc']=="V"){print('SELECTED');}?>>Seleccione</option>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Código BN <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Código del Bien Nacional."><i class="fa fa-question" ></i></span></label>
            ...
            <div class="col-lg-6 span6">
                <label>Seleccione Condición <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Condición del Bien Nacional."><i class="fa fa-question" ></i></span></label>
                <select name="nacionalidaddoc" id="cam_nacionalidaddoc">
                    <option value="" <?php if($Datos_Docente['nacionalidaddoc']=="V"){print('SELECTED');}?>>Seleccione</option>
        ...
        <div class="row-fluid">
            <div class="col-lg-6 span6">
                <label>Seleccione la Asignatura para asignar el BN <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Asignatura del Bien Nacional."><i class="fa fa-question" ></i></span></label>
                <select name="nacionalidaddoc" id="cam_nacionalidaddoc">
                    <option value="" <?php if($Datos_Docente['nacionalidaddoc']=="V"){print('SELECTED');}?>>Seleccione (Opcional)</option>
                    <option value="V" <?php if($Datos_Docente['nacionalidaddoc']=="V"){print('SELECTED');}?>>Disponible</option>
                    <option value="V" <?php if($Datos_Docente['nacionalidaddoc']=="V"){print('SELECTED');}?>>Asignado</option>
                    <option value="E" <?php if($Datos_Docente['nacionalidaddoc']=="E"){print('SELECTED');}?>>En Reparación</option>
                    <option value="E" <?php if($Datos_Docente['nacionalidaddoc']=="E"){print('SELECTED');}?>>Desincorporado</option>
            ...
            <div class="col-lg-6 span6">
                <label>Fecha de Asignación <span class="label label-warning" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="right" data-content="Fecha de nacimiento del docente."><i class="fa fa-question" ></i></span></label>
